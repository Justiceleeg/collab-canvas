...
// Top bar with logo, presence avatars, undo/redo, and user menu
...
export default function Navbar() {
  ...
  return (
    <div className="navbar fixed top-0 left-0 right-0 z-50 bg-white shadow-md border-b border-gray-200">
      <div className="navbar-container max-w-screen-2xl mx-auto px-4 py-3 flex items-center justify-between">
        {/* Left section - Logo */}
        <div className="navbar-left flex items-center gap-4">
          ...
          <div className="navbar-divider h-8 w-px bg-gray-300"></div>
